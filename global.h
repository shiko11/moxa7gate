...
// исключение для пожарных датчиков ИПЭС, параметр - битовый массив номеров последовательных портов с пожарными шлейфами
#define EXCEPTION_IPES   0x00000002

unsigned int exceptions; // массив из 16 флагов
unsigned int except_prm[16]; // параметр исключения
unsigned int except_counters[16]; // массив счетчиков ответов, содержащих сигнал "пожар" в ИПЭС
