...
///*** нопедекеммше ярюмдюпрнл йнмярюмрш опнйнкю MODBUS
///*** тсмйжхх ббндю/бшбндю, опедмюгмювеммше дкъ пюанрш я MODBUS
///*** тсмйжхх йнмтхцспюжхх юооюпюрмшу хмрептеиянб

#include "statistics.h" /* СВЕР ЯРЮРХЯРХЙХ КХЬМХИ ГДЕЯЭ */
...
/* Predel'nye размеры */
#define		MB_TCP_MAX_ADU_LENGTH 260		/* ЛЮЙЯХЛЮКЭМЮЪ ДКХМЮ ОЮЙЕРЮ  TCP MODBUS ADU ОПХМХЛЮЕЛНЦН НР OPC */
#define 	MB_TCP_ADU_HEADER_LEN 7
#define MB_SERIAL_MAX_ADU_LEN   256       // ЛЮЙЯХЛЮКЭМЮЪ ДКХМЮ ОЮЙЕРЮ-НРБЕРЮ
#define MB_SERIAL_MIN_ADU_LEN   3              // ЛХМХЛЮКЭМЮЪ ДКХМЮ ОЮЙЕРЮ-НРБЕРЮ (7
