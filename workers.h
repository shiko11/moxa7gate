...
void *srvr_tcp_child(void *arg); //прием - передача данных по Modbus TCP
void *srvr_tcp_child2(void *arg); //прием - передача данных по Modbus TCP
void *srvr_tcp_bridge(void *arg); //прием - передача данных по Modbus TCP
void *gateway_proxy_thread(void *arg); //прием - передача данных по Modbus TCP
void *bridge_proxy_thread(void *arg); //прием - передача данных по Modbus TCP
